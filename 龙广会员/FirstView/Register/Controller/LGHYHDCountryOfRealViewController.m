//
//  LGHYHDCountryOfRealViewController.m
//  龙广会员
//
...
#import "LGHYHDCountryOfRealViewController.h"
#import "LGHYHDTextField.h"

@interface LGHYHDCountryOfRealViewController ()<UITextFieldDelegate>
...
@implementation LGHYHDCountryOfRealViewController
...
- (LGHYHDTextField *)nameTextField {
    if (!_nameTextField) {
        ...
        _nameTextField.placeholder = @"请输入民族...";
