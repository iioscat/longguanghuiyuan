//
//  LGHYHDSexOfRealViewController.m
//  龙广会员
//
...
#import "LGHYHDSexOfRealViewController.h"
#import "LGHYHDTextField.h"

@interface LGHYHDSexOfRealViewController ()<UITextFieldDelegate>
...
@implementation LGHYHDSexOfRealViewController
...
- (LGHYHDTextField *)nameTextField {
    if (!_nameTextField) {
        ...
        _nameTextField.placeholder = @"请输入性别...";
