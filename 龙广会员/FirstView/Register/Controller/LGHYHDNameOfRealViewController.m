//
//  LGHYHDNameOfRealViewController.m
//  龙广会员
//
...
#import "LGHYHDNameOfRealViewController.h"
#import "LGHYHDTextField.h"

@interface LGHYHDNameOfRealViewController ()<UITextFieldDelegate>
...
@implementation LGHYHDNameOfRealViewController
...
- (UILabel *)reminderLabel {
    if (!_reminderLabel) {
        ...
        _reminderLabel.text = @"请输入真实姓名，限4-16个字符，一个汉字为2个字符";
